...
$x\cdot u=x\cdot v$ (\emph{homotypical} identities\index{identity
of unary algebras!homotypical}) or $x\cdot u=y\cdot v$ with $x\ne
y$ (\emph{heterotypical} identities\index{identity of unary
algebras!heterotypical}). It is easy to realize that a DFA is
