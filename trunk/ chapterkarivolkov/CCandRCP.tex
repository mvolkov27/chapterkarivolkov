...
and words that it appends to the current word has length at most $\alpha n$.
Hence the length of the \sw\ returned by the algorithm does not exceed
...
so we see that the \v{C}ern\'{y} conjecture holds true for such automata.
